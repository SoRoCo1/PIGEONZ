...
export default function PartnerChat({ userName, userEmail, userRole }: { userName: string; userEmail: string; userRole: string }) {
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
              <div style={{
                ...
                <svg width={16} height={16} viewBox="0 0 24 24" fill="none" stroke="#1c1030" strokeWidth={2.5} strokeLinecap="round" strokeLinejoin="round">
                  <path d="M21 15a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/>
                </svg>
              </div>
              <div>
              ...
              return (
                <div key={i} style={{
                  ...
                  <div style={{
                    ...
                    border: `1px solid ${isMine ? T + "33" : K + "22"}`,
